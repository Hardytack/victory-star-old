...
<div id="navbar" class="clearfix">
    <div id="navP1">
        ...
        <div class="dropdown">
            ...
            <div class="dropdownContent navButton">
                <a href="sets.php?format=standard" class="dropdownMenu">Standard</a>   
                <a href="sets.php?format=expanded" class="dropdownMenu">Expanded</a>
                <a href="sets.php?format=unlimited" class="dropdownMenu">Unlimited</a>
